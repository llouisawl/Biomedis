  ...
  <body>
    ...
    <section class="hero">
      <div class="hero-content">
        ...
        <p>
          Konsultasi dan layanan medis terkait kesehatan reproduksi wanita oleh dokter spesialis kandungan
        </p>
      </div>
    </section>
    ...
    <section id="poli-info" class="poli-container">
      <div class="poli-box">
        <img src="Images/poli_kandungan.jpg" alt="Poli Anak" />
        <div class="poli-content">
          <h2>Deskripsi Poli Kandungan</h2>
          <p>
            Poli Kandungan memberikan layanan konsultasi, pemeriksaan rutin, dan tindakan medis terkait kehamilan dan masalah kesehatan wanita lainnya
            Anda.
          </p>
          <h3>Jadwal Layanan</h3>
           ...
           <table>
            ...
            <tbody>
              ...
              $query = "SELECT name, hari, jam FROM dokter WHERE Lokasi LIKE '%Poli Kandungan%'";
