  ...
  <body>
      ...
      <nav class="navbar">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu">
            ...
            <a href="poli-anak.php">Poli Anak</a>
    ...
    <section class="hero">
      <div class="hero-content">
        <h1>Poli Kulit dan Kelamin</h1>
        <p>
          Layanan medis untuk masalah kulit dan kelamin oleh dokter spesialis
          kulit dan kelamin
        </p>
      </div>
    </section>
    ...
    <section id="poli-info" class="poli-container">
      <div class="poli-box">
        <img src="Images/poli_kulit.jpg" alt="Poli Anak" />
        <div class="poli-content">
          <h2>Deskripsi Poli Kulit dan Kelamin</h2>
          <p>
            Poli Kulit dan Kelamin memberikan pelayanan untuk diagnosis dan
