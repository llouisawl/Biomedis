...
<html lang="en">
  <head>
    ...
    <title>Poli Penyakit Dalam</title>
  ...
  <body>
    ...
    <section class="hero">
      <div class="hero-content">
        ...
        <p>
          Layanan medis untuk diagnosis dan perawatan berbagai penyakit organ
          dalam oleh dokter spesialis yang berpengalaman.
        </p>
      </div>
    </section>
    ...
    <section id="poli-info" class="poli-container">
      <div class="poli-box">
        <img src="images/poli_pd.jpg" alt="Poli Penyakit Dalam" />
        <div class="poli-content">
          <h2>Deskripsi Poli Penyakit Dalam</h2>
          <p>
            Poli Penyakit Dalam menyediakan layanan untuk diagnosis, pengobatan,
            dan pencegahan berbagai penyakit pada organ dalam, seperti gangguan
            pencernaan, penyakit hati, ginjal, diabetes, dan hipertensi.
          </p>
          <h3>Jadwal Layanan</h3>
           ...
           <table>
            ...
            <tbody>
              ...
              $query = "SELECT name, hari, jam FROM dokter WHERE Lokasi LIKE '%Poli Penyakit Dalam%'";
